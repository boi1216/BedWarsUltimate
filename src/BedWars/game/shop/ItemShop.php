...
class ItemShop
{
	...
	public static function handleBowTransaction(int $data, Item $item)
	{
		switch ($data) {
			case 1;
				$enchantment = new EnchantmentInstance(EnchantmentIdMap::getInstance()->fromId(EnchantmentIds::POWER), 1);
				$item->addEnchantment($enchantment);
				break;
			case 2;
				$enchantment = new EnchantmentInstance(EnchantmentIdMap::getInstance()->fromId(EnchantmentIds::POWER), 1);
				$enchantment1 = new EnchantmentInstance(EnchantmentIdMap::getInstance()->fromId(EnchantmentIds::PUNCH), 1);
